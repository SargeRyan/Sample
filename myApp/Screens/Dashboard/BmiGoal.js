...
export default BmiGoal = ({ bmr, calorieIntake, burnedCalorie }) => {
    ...
    return (
        <View style={{ display: "flex", justifyContent: "center", backgroundColor: "#156d94", padding: 10, marginHorizontal: 10, marginTop: 15, borderRadius: 10 }}>
            ...
            <View style={{ flexDirection: "row", alignSelf: "center" }}>
                ...
                <Text style={{ fontSize: 15, fontWeight: "bold", color: "#fff", textAlign: "center", alignSelf: "center" }}> KCAL | Goal to Gain</Text>
            </View>
            ...
            <View style={{ flexDirection: "row", alignSelf: "center" }}>
                <Text style={{ fontSize: 40, fontWeight: "bold", color: "#ffb8c3", textAlign: "center", alignSelf: "center" }}>{Math.round(burnedCalorie)}</Text>
                <Text style={{ fontSize: 15, fontWeight: "bold", color: "#ffb8c3", textAlign: "center", alignSelf: "center" }}> KCAL | Burned</Text>
            </View>
            <View style={{ flexDirection: "row", alignSelf: "center", borderTopWidth: 2, borderTopColor: "#fff", width: "100%", justifyContent: "center" }}>
                <Text style={{ fontSize: 40, fontWeight: "bold", color: "#41ffc3", textAlign: "center", alignSelf: "center" }}>{ Math.round(Number(bmr) - Number(calorieIntake) + Math.round(burnedCalorie))}</Text>
